...
public class Cilent
{
	...
	public static void main (String[] args)
	{
		...
		QuickAutocompete quickAutocompete = new QuickAutocompete();
		...
		System.out.println("The weight of " + input +" is " + bruteAutocomplete.weightOf(input)+ "\n");
			...
			System.out.println("The word " + input + " is not in the list");
		}
		...
		System.out.println(QuickAutocompete.colectionK);
